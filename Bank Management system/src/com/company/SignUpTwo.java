...
public class SignUpTwo extends JFrame implements ActionListener {
    ...
    SignUpTwo(String formno){
        ...
        JLabel additionaldetail = new JLabel("Page -2 : Additional Details Form No-"+formno);
        additionaldetail.setFont(new Font("Raleway",Font.BOLD,28));
        additionaldetail.setBounds(130,55,700,40);
    ...
    try {
        Conn c= new Conn();
        String query="insert into signuptwo values('"+formno+"','"+sreligon+"','"+scatagory+"','"+sincome+"','"+seducate+"','"+soccupation+"','"+spannumber+"','"+sadharnumber+"','"+seniorcitz+"','"+existaccount+"')";
